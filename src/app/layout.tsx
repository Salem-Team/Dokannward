...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/favicon.ico?v=dw3", sizes: "any" },
        { url: "/favicon-16x16.png?v=dw3", sizes: "16x16", type: "image/png" },
        { url: "/favicon-32x32.png?v=dw3", sizes: "32x32", type: "image/png" },
        { url: "/icon-192.png?v=dw3", sizes: "192x192", type: "image/png" },
        { url: "/icon-512.png?v=dw3", sizes: "512x512", type: "image/png" },
      ],
      apple: [
        { url: "/apple-touch-icon.png?v=dw3", sizes: "180x180", type: "image/png" },
      ],
      shortcut: ["/favicon.ico?v=dw3"],
    },
