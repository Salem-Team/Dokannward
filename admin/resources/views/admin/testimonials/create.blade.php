...
@section('content')
    <div class="admin-page-stack">
        <x-admin.page-header
            ...
            subtitle="Add a customer story for the homepage."
            back-url="{{ route('admin.testimonials.index') }}"
            back-label="Back to Testimonials"
        />

        <x-admin.card>
            <form action="{{ route('admin.testimonials.store') }}" method="POST" class="space-y-6" data-turbo="false">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <x-admin.social-source :value="old('source')" />
                    </div>
